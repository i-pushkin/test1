...
# Check if sufficient memory is available (at least 24 GB)
...
if [[ $docker_status -eq 0 && $compose_status -eq 0 && $memory_status -eq 0 && $disk_status -eq 0 && $license_status -eq 0 && $dockerhub_status -eq 0 && $run_status -eq 0 && $iptables_check_status -eq 0 ]]; then
